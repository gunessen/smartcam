...
python3 evaluate.py --model yolov5-small --batch_size 100 --num_threads 4 > yolov5-small.txt
python3 evaluate.py --model yolov5-nano --batch_size 100 --num_threads 4 > yolov5-nano.txt
